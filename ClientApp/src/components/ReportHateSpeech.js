        ...
        <div>
          ...
          <Form onSubmit={this.handleSubmit}>
            <FormGroup controlId="formControlsTextarea" bsSize="large">
              <Row>
                <Col sm={12}>
                  <FormControl type="multitext" componentClass="textarea" style={{height: '200px'}} placeholder={this.state.placeholder} name='hateText' value={this.props.location.referrer.hateSpeech} required/>
                </Col>
              </Row>
              <Row style={{marginTop: '10px'}}>
                <Col sm={12}>
                  <FormControl type="url" placeholder="Evidence Link e.g https://web.facebook.com/ameenukano585/posts/1987380447959756" name='evidanceLink'/>
                </Col>
              </Row>
              <Row>
                <Col sm={6} style={{marginTop: '10px'}}>
                  <FormControl type="text" placeholder="Source e.g Facebook" bsSize="large" name='source' value={this.props.location.referrer.platform} required/>
                </Col>
                <Col sm={6} style={{marginTop: '10px'}}>
        ...
        <div>
          ...
          <Form onSubmit={this.handleSubmit}>
            <FormGroup controlId="formControlsTextarea" bsSize="large">
              <Row>
                <Col sm={12}>
                  <FormControl type="multitext" componentClass="textarea" style={{height: '200px'}} placeholder={this.state.placeholder} name='hateText' required/>
                </Col>
              </Row>
              <Row style={{marginTop: '10px'}}>
                <Col sm={12}>
